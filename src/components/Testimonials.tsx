              ...
              {displayedVideoTestimonial && displayedVideoInfo ? (
                <div>
                  <div className="relative pt-[56.25%] bg-black rounded-lg overflow-hidden shadow-xl"> {/* 16:9 Aspect Ratio */}
                    {displayedVideoInfo.type === 'youtube' ? (
                      <iframe
                        className="absolute top-0 left-0 w-full h-full"
                        src={`https://www.youtube.com/embed/${displayedVideoInfo.source}?rel=0&showinfo=0`}
                        title={`Depoimento de ${displayedVideoTestimonial.name}`}
                        frameBorder="0"
                  ...
                  {/* Informações do depoimento abaixo do vídeo */}
